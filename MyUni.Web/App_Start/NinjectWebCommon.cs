...
[assembly: WebActivatorEx.ApplicationShutdownMethodAttribute(typeof(MyUni.Web.App_Start.NinjectWebCommon), "Stop")]

namespace MyUni.Web.App_Start
{
    using System;
    using System.Web;
    ...
    public static class NinjectWebCommon 
    {
        ...
        {
            var appDependencyResolver = new MyUniDependencyResolver(kernel);
